...
import helium314.keyboard.settings.screens.createKamelotSettings
...
private fun createSettings(context: Context) = createAboutSettings(context) + createAppearanceSettings(context) +
        ...
        createLayoutSettings(context) + createAdvancedSettings(context) + createKamelotSettings(context) +
